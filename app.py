...
img_width , img_height = 200 , 200 #we set our input dimension as 200x200
face_cascade = cv2.CascadeClassifier('haarcascade_frontalface_default.xml') #to detect the faces
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        # save detected faces with mask into with_mask folder
        if pred == 0:
        ...
        # save detected faces without mask into without_mask folder
        else:
